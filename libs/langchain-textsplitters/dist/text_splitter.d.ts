...
export declare abstract class TextSplitter extends BaseDocumentTransformer implements TextSplitterParams {
    ...
    protected splitOnSeparator(text: string, separator: string, offset?: number): Promise<ChunkWithMetadata[]>;
    ...
    private joinDocs;
    mergeSplits(splits: ChunkWithMetadata[], separator: string): Promise<ChunkWithMetadata[]>;
}
...
export declare class RecursiveCharacterTextSplitter extends TextSplitter implements RecursiveCharacterTextSplitterParams {
    ...
    private _splitText;
    splitText(text: string): Promise<string[]>;
    splitTextWithMetadata(text: string): Promise<ChunkWithMetadata[]>;
